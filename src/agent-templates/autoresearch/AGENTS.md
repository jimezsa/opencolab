...
8. Read `projects/SKILLS/autoresearch/SKILL.md` before running iterative experiment work, and read other relevant shared or local skills before using them.
