...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-root", default="research/figures", help="Root output directory. Prefer <RUN_ROOT>/figures for topic-scoped research runs.")
    parser.add_argument("--pageindex-tree", default=None, help="Optional PageIndex tree JSON path.")
    parser.add_argument("--pageindex-manifest", default="research/pageindex/manifest.json", help="Optional PageIndex manifest JSON path. Prefer <RUN_ROOT>/pageindex/manifest.json for topic-scoped research runs.")
